<?php
  session_start();//Reanudar la sesión en el caso de que haya sido iniciada anteriormente
    ...
    require_once ("../controllers\centrales\coordenadas_central.php");
    $lista_coordenadas_central =json_encode($lista_coordenadas_central, true);
    echo '<div id="lista_coordenadas_central">'. $lista_coordenadas_central . '</div>';
...
<head>
    ...
    <meta name="author" content="Hector Antonio Azamar Leal">
    <meta name="author" content="hector.azamar23@gmail.com">
...
<header>
    <div class="contenedor">
        ...
        <nav>
            <ul>
                <li class="actual"><a href="inicio_view.php">Inicio</a></li>
...
<section>
    ...
    <form action="../views/inicio_view.php" method="GET">
        <button class="btn btn-info al-but" >Buscar</button>
        <div class="container filtro">
...
<div id="map" class="container">
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBSPUr6RrDWAJrO9wI1RPtDTmuOhOfVfMc&callback=initMap">
    </script>
</div>
