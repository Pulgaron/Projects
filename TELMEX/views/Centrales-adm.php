...
session_start();//Reanudar la sesión en el caso de que haya sido iniciada anteriormente
	if (!isset($_SESSION["iduser"])){//Si se almaceno algo en la variable super global
        ...
        header("Location:../views/centrales.php");
	    }
...
<body>
  <header>
    <div class="contenedor">
      ...
      <nav>
        <ul>
          <li ><a href="Listado-adm.php">Usuarios</a></li>
              ...
              <h3 class="alineacion"> Centrales</h3>
                ...
                foreach ($lista_cm as $centrales):
                    ...
                    <tr>
                        ...
                        <td><a href="actualizaciones.php?Siglas=<?php echo $centrales["Clave_Cm"];?>" class="btn btn-success"><span class="glyphicon glyphicon-upload"> Visualizar</span></a></td>
